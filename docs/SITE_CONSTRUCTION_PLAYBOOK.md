...
| UI 与无障碍 | N27 已在本地完成首页搜索、图谱键盘/触控等价路径、单树响应式 TOC、页面来源/核验范围、44px 控件、Next font、禁用广告空状态及 375/768/769/1024/1440 响应式修正。 | Chromium Playwright + axe 20/20 通过；代表生产页面无横向溢出、console/page error 或 first-party 4xx/5xx。本轮未发布，线上状态未改变。 |
