...
| 验证 | C1 建立 12 页呈现回归；C2 增加 D3 深度、三层阅读、逐项证据和全来源可达合同；C3 增加 D2 内容合同；C4 增加 D1 性质、来源和关系证据合同；C5 增加 Works/Concepts 的来源、关系、去重与无占位回归；C6 增加 Scholar 的身份、归因边界、关系和无占位回归；C7 增加主题、学科、领域的三类理论路径、来源和无占位回归。2026-07-13 本地 C7 验收已通过：seed、62 项测试、lint、92 页构建、差异检查和主题/学科/领域代表页浏览器检查均已记录。 | C8 仍须逐页重跑全站自动化和浏览器门禁。 |
