...
export function TheoryArticle({ theory, internalLinks = [] }: { theory: TheoryArticleData; internalLinks?: InternalLink[] }) {
  ...
  return <article className="entity-page content-layout">
    ...
    <RelatedLinks heading="Connected theories" links={relationshipLinks.map((item) => ({ label: item.titleEn, href: `/theories/${item.slug}`, description: "Explore this theoretical relationship" }))} />
