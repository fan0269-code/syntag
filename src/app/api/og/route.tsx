...
export function GET(request: Request) {
  ...
  const kind = url.searchParams.get("kind")?.slice(0, 60) || "Syrtag";
  ...
  return new ImageResponse(
    <div style={{ alignItems: "flex-start", background: "#0a0a0f", color: "#f0f0f5", display: "flex", flexDirection: "column", height: "100%", justifyContent: "space-between", padding: "72px", width: "100%" }}>
      ...
      <div style={{ alignItems: "center", color: "#8a8a96", display: "flex", fontSize: 30, gap: "18px" }}><span style={{ color: "#4da6ff" }}>Syrtag</span><span>Research Theory Knowledge Graph</span></div>
    </div>,
